...
#ifndef QUIZIE_SWIFT_H
#define QUIZIE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="quizie",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC6quizie11AppDelegate")
...
SWIFT_CLASS("_TtC6quizie13SceneDelegate")
...
SWIFT_CLASS("_TtC6quizie14ViewController")
...
- (void)viewDidLoad;
- (IBAction)responseButtonPressed:(UIButton * _Nonnull)sender;
- (void)changeQuestion;
